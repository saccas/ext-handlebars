...
namespace Visol\Handlebars\Tests\Functional;
...
abstract class AbstractTestCase extends FunctionalTestCase
{
    protected function setUp(): void
    {
        ...
        $this->pathsToLinkInTestInstance = [
            'typo3conf/ext/handlebars/Tests/Functional/Fixtures/Frontend/Sites/' => 'typo3conf/sites',
        ];
    ...
    protected function fetchContentForPage(int $pageUid): string
    {
        ...
        $result = $this->executeFrontendSubRequest($request)->getBody()->__toString();
        $result = trim($result);
